...
from libs.data import get_dataset, get_loader
from libs.helper import load_config, get_model, get_optimizer, get_scheduler, EarlyStopping, get_loss
...
# --- CONFIG ---
CONFIG_PATH = "/kaggle/working/sweep.yaml"  # <-- set your config path
config = load_config(CONFIG_PATH)

# --- DATASET ---
TRAIN_DATA_DIR_PATH = '/kaggle/input/mushroom-classification/private_test/train'
TEST_DATA_DIR_PATH = '/kaggle/input/mushroom-classification/private_test/test'
